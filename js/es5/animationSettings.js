...
var animationSettings = function () {
    ...
    var settings = {
        ...
        safariCaveatHeading: 'Please note:',
        safariCaveat: 'This animation is better viewed on a different browser to Safari on an iOS mobile device (iPad or iPhone). Safari mobile does not work well (renders slowly) with the ScrollMagic JavaScript Library that this animation uses. For more information:',
        safariCaveatSmall: 'This animation is better viewed on a different browser to Safari on an iOS mobile device. For more information:',
        safariCaveatLink: 'https://github.com/janpaepke/ScrollMagic/issues/256#issuecomment-91181959',
        ...
        // paraTwo : '<strong>Mediation Sessions</strong> are usually joint meetings between you are your former partner, though you may also include family members and child guardians at your discretion.<br><br> The Family Mediator\'s role is to facilitate free speech, and help both parties to arrive at mutual decisions on topics which commonly include <strong>property, children, and finance</strong>.<br><br> At any point during this process, you are free to seek independent legal advice. Mediation usually takes between one and six 90 minute long sessions.',
        paraTwo: '<strong>Mediation Sessions</strong> are usually joint meetings between you are your former partner, though you may wish to include family members and child guardians as well.<br><br> The Family Mediator\'s role is to guide you through the process, facilitating free speech, and helping both parties to arrive at mutual decisions on topics which commonly include <strong>property, finance, and childcare</strong>.',
        paraThree: 'At the <strong>end of mediation</strong>, the proposals you and your former partner have agreed to will be recorded for you in a document by the Mediator.<br><br> These proposals can be made legally binding with the assistance of a solicitor, should you wish.',

        // end call to action

        endCtaHeading: 'Want to find out more?',
        endCtaSub: 'Contact Able Mediation for a free 20 minute telephone consultation',
        endCtaLinkText: 'Speak to a Family Mediator now',
        endCtaLinkTextSmall: 'Contact Us',
        endCtaLink: 'https://www.ablemediation.com/contact/'

        // The role of the Family Mediator in these sessions is to facilitate free speech, help you to negotiate decisions that both parties accept, and <strong>signpost you through the process</strong>. At any point during this process, you are free to seek independent legal advice. Mediation usually takes between one and six 90 minute long sessions.
