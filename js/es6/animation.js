...
const safariHead = animationSettings.safariCaveatHeading,
...
if (userAgent.match(/iP(ad|hone|od).+Version\/[\d\.]+.*Safari/i)) {
    ...
    safariMobMsg.innerHTML =
    `<div class="container" data-small="${safariMsgSmall}" data-big="${safariMsg}">
        <h3>${safariHead}</h3>
...
// }
    ...
    function safariText() {
        ...
        if (window.innerWidth < 660) {
            const smText = document.querySelector('.safariMobile .container').getAttribute('data-small');
            const currentText = document.querySelector('.safariMobile .container p').textContent;
        ...
        // large text
            ...
            const lgText = document.querySelector('.safariMobile .container').getAttribute('data-big');
            const currentText = document.querySelector('.safariMobile .container p').textContent;
            // only run once per resize:
        ...
        const height = document.querySelector('.safariMobile .container').scrollHeight;
